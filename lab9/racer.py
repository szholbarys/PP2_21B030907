...
photo = pygame.image.load(os.path.join('images', 'bg.png'))
...
class Enemy(pygame.sprite.Sprite):
    def init(self):
        super().init()
        self.image = pygame.image.load(os.path.join('pict', 'Enemy.png'))
...
class Player(pygame.sprite.Sprite):
    def init(self):
        super().init()
        self.image = pygame.image.load(os.path.join('pict','Player.png'))
        self.rect = self.image.get_rect()
